...
namespace MicrowaveIntegrationTest
{
    class Step8_UserInterface_CookControle
    {
        ...
        //The user clicks on StartCancel button, opens the door and removes the food - the timer stops and show Display cleared 
        [Test]
        public void OnDoorOpened_DoorOpens_StopCookingIsCalledWithStop()
        {
            //act
            _powerButton.Press();
            _timeButton.Press();
            ...
            _fakeOutput.Received().OutputLine(Arg.Is<string>(s => s.Contains("Display cleared")));
